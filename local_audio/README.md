...
1.  There are two main versions of the add-on. Download one of the two.
    ...
    - **Option 1**: [SQL-based](https://github.com/Aquafina-water-bottle/jmdict-english-yomichan/blob/sql_09/local_audio/sql_09/localaudio_sql09__2023_01_15.ankiaddon?raw=true) (highly recommended)
